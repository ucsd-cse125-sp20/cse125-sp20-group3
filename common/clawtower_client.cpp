...
ClawTower_Client::ClawTower_Client(GameObjectData data, int id, Team* t, SceneManager_Client* sm_c, OzzGeode* geode, Transform* parent) : ClawTower(data, id, t, nullptr), Entity_Client(sm_c)
{
