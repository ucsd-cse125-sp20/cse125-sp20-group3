...
#define MINION_ATTACK_RANGE 5
#define SUPER_MINION_ATTACK_RANGE 10
#define CLAW_TOWER_ATTACK_RANGE 15
#define LASER_TOWER_ATTACK_RANGE 20

#define CLAW_SPAWN_INTERVAL 5.0
#define ATTACK_INTERVAL 2.0
